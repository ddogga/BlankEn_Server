...
//    public Page<QuizSetResDto> findAllQuizSet(Pageable pageRequest) {
//        Page<QuizSetResDto> pages = quizRepository.findAllByShared(true,pageRequest)
//                .map(QuizSet :: toDto);
//
//
//        return pages;
//    }
    ...
    public Page<QuizSet> findAllQuizSet(Pageable pageRequest) {
        Page<QuizSet> pages = quizRepository.findAllByShared(true, pageRequest);
