package blank.english.config.auth.handler;
...
import blank.english.config.utils.CookieUtils;
...
import static blank.english.config.auth.repository.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
